...
- **Architectures:** Per default, we use the DeepSphere graph convolutional neural networks [[Defferrard et al. 2020](https://arxiv.org/abs/2012.15000)] from the PyTorch [`deepsphere-pytorch`](https://github.com/deepsphere/deepsphere-pytorch) package. Alternative choices include 1D convolutional networks and vision transformers.
...
- [`deepsphere-pytorch`](https://github.com/deepsphere/deepsphere-pytorch) for graph convolutional neural networks on the pixelized sphere
...
# Install PyTorch DeepSphere (graph convolutional networks in PyTorch)
pip install git+https://github.com/deepsphere/deepsphere-pytorch.git
```
