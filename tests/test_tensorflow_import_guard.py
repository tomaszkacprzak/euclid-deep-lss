...
ALLOWED_TENSORFLOW_IMPORTS = {
    ...
    Path("deep_lss/deprecated/estimators.py"),
    Path("deep_lss/deprecated/layers.py"),
    ...
    Path("deep_lss/nets/legacy/bary_net_partial.py"),
    Path("deep_lss/nets/legacy/bary_net_partial_v2.py"),
    Path("deep_lss/nets/legacy/bary_net_partial_v3.py"),
    Path("deep_lss/nets/legacy/big_resnet.py"),
    Path("deep_lss/nets/legacy/big_resnet_partial.py"),
    Path("deep_lss/nets/legacy/small_resnet.py"),
    Path("deep_lss/nets/legacy/small_resnet_partial.py"),
    Path("deep_lss/nets/legacy/small_resnet_partial_v2.py"),
    Path("deep_lss/nets/legacy/small_resnet_partial_v3.py"),
    Path("deep_lss/nets/legacy/small_resnet_v2.py"),
